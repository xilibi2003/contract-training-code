...
// manager
contract CallOptFactory {  // CallOptFactory ERC1155 


  function create(uint price , uint settlementTime) {
    address opt = createclone(CallOptTokenImpl);  // ERC20 -> ERC1155 tokenID

  }

  function withdraw(address[] memory  opts) {
